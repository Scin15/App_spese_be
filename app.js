...
import { registerUser, loginUser, logoutUser, protectedRoute } from './controllers/app.autentication.js'
import 'dotenv/config' // libreria dotenv per usare le variabili di ambiente con process.env.<variabile>
import * as cookieParser from 'cookie-parser' // libreria per la gestione di cookie
const app = express()
